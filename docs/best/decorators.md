...
* Decorators are only supported out of the box in `create-react-app@^2.1.1`. In older versions fix this by can using either the `decorate` utility, eject, or the [customize-cra](https://github.com/arackaf/customize-cra) package.
